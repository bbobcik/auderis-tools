 ...
 * </p>
 * In order to improve readability, the leading (i.e. most significant) time unit has typically
...
public abstract class SimpleDurationFormat implements Serializable {
	 ...
	 * <p/>
	 * If the checked {@link java.io.IOException} is deemed unnecessary (e.g. while
	 ...
	 * human-readable representation and appends it to the {@code target}.
	 * <p/>
	 * This method differs from {@link #toHumanDuration(long, Appendable)}
	 ...
	 * human-readable representation and appends it to the {@code target}.
	 * <p/>
	 * This method differs from {@link #toHumanDuration(long, java.util.concurrent.TimeUnit, Appendable)}
	 ...
	 */
	protected static final TimeUnit[] DURATION_UNITS = {
			TimeUnit.DAYS,
			TimeUnit.HOURS,
			TimeUnit.MINUTES,
			TimeUnit.SECONDS };
